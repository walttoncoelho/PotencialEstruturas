...
import { Container, Grid1, Grid2, Grid3, Grid4, WhatsService,  } from "../styles/style";
    ...
    <>
      {procedimentos.map((item) => (
        <Container key={item.id}>
          <Grid1>
            <img src={item.image[0]} alt={item.image_alt} />
            <img src={item.image[1]} alt={item.image_alt} />
            <img src={item.image[2]} alt={item.image_alt} />
          </Grid1>
          <Grid2>
            <Grid3>
              <h3>{item.service}</h3>
