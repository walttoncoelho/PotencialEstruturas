...
import { Container,  Card, Header, CardWhats} from "./style";
import { ButtomWhatsAppHome } from "../../../components/buttons/style"; 
  ...
  return (
    <>
      ...
      <Container>
          ...
          <Card>
            <h5>SERVIÇOS DE TRATAMENTO E REVESTIMENTO EM METAIS</h5>
          </Card>
          ...
          <Card>
            <h5>INSTALAÇÃO E MANUTENÇÃO ELÉTRICA</h5>
          </Card>
        
      
          <Card>
            <h5>INSTALAÇÕES HIDRÁULICAS, SANITÁRIAS E DE GÁS</h5>
          </Card>
